...
public class Stats {
    ...
    private static final String TAG = "xhrLauncher/Stats";

    private static final boolean LOCAL_LAUNCH_LOG = true;

    public static final String ACTION_LAUNCH = "com.xhr.launcher.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.xhr.launcher.permission.RECEIVE_LAUNCH_BROADCASTS";
